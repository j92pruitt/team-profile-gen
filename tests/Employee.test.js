...
describe('Employee', () => {
    ...
    describe('Initialization', () => {
        ...
        it('should create an object with "name" property set to "name" parameter.', () => {
        ...
        it('should create an object with "id" property set to "id" parameter.', () => {
        ...
        it('should create an object with "email" property set to "email" parameter.', () => {
